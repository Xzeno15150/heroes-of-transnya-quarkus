...
import fr.multiplatform.hot.resources.dtos.party.PartyPartialRequest;
import fr.multiplatform.hot.resources.dtos.party.PartyPartialResponse;
...
public interface PartyPartialMapper {

    PartyPartial toEntity(@Nonnull PartyPartialRequest partyPartial);

    PartyPartialResponse toResource(@Nonnull PartyPartial partyPartial);
}
